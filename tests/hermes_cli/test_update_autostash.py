...
def _setup_keep_stash_test(monkeypatch, tmp_path):
    ...
    # The updater purges and re-imports Hermes modules after its simulated
    # pull, so patch the stable stdlib platform marker rather than a gateway
    # function whose module object is intentionally discarded mid-test.
