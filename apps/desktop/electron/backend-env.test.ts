...
test('desktop backend PATH adds Hermes-managed bins and missing POSIX sane entries', () => {
  ...
  assert.equal(entries[3], '/Users/test/.local/bin')
...
test('buildDesktopBackendEnv extends PYTHONPATH and backend PATH together', () => {
  ...
  assert.ok(
    env.PATH.startsWith(
      '/Users/test/.hermes/node/bin:/Users/test/.hermes/node:/Users/test/.hermes/hermes-agent/venv/bin:/Users/test/.local/bin:'
    )
  )
